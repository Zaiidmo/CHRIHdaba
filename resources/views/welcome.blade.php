    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="gap-6 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-3 lg:py-16 lg:px-6">
            <div class="font-light h-full col-span-2 text-gray-500 sm:text-lg dark:text-gray-400">
                <div
                    class="w-full h-full p-6 bg-white border border-gray-200 rounded-3xl shadow dark:bg-gray-800 dark:border-gray-700">
                    <h1 class="mb-4 text-4xl font-bold tracking-tight text-gray-900 dark:text-white">Welcome to CHRIHdaba
                    </h1>
                    <p class="mb-4">CHRI</p>
                </div>
            </div>
