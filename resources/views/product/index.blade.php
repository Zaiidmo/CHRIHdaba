            ...
            <div class="lg:w-full mx-auto">
                ...
                <div class="relative border-gray-300 py-10 mb-4 rounded-xl">
                    ...
                    <div class="relative max-w-screen-md text-center mx-auto">
                        <h2 class="mb-4 text-4xl tracking-tight font-bold text-gray-900">Style and Performance, Sports
                            Apparel Section</h2>
                        <p class="text-gray-500 sm:text-xl dark:text-gray-400">A sports apparel section where comfort and
                            performance converge in a perfect blend of style and functionality.</p>
                    </div>
                    ...
                    <div class="flex flex-wrap justify-center items-center">
                        <div
                            ...
                            <a href="#">
                                <img class="p-8 rounded-t-lg" src="{{ asset('assets/images/product.png') }}"
                                    alt="product image" />
                            </a>
                            <div class="px-5 pb-5">
                        ...
                        <div
                            ...
                            <div class="px-5 pb-5">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <form action="card">
                                        <button  class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add
                                            to cart
                                        </button>
                                    </form>
                                </div>
