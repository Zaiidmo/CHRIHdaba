...
@section('content')
    <section class="sm:flex sm:flex-col lg:grid lg:grid-cols-3 text-gray-600 body-font pt-24 lg:px-64">
        <div class="lg:col-span-2 flex flex-col gap-4 cart-container">
            ...
            @else
                ...
                @foreach ($cardProducts as $cardProduct)
                    <div class="flex gap-4 w-auto justify-between items-center mr-16 product-container">
                        <div
                        ...
                        <button class="deleteFromCart mt-4 font-semibold text-red-400 text-sm"
                            data-product-id="{{ $cardProduct->id }}">Remove</button>
                    </div>
