...
<section class="text-gray-600 body-font overflow-hidden">
	...
	<div class="container px-5 py-24 mx-auto">
	  ...
	  <div class="lg:w-4/5 mx-auto flex flex-wrap">
		<img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center"  style="border-radius: 3rem;" src="https://dummyimage.com/400x400">
		<div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
		  ...
		  <div class="flex gap-8">
            ...
            <div class="flex gap-4">
                <div class="border p-2">XS</div>
                <div class="border p-2">S</div>
                <div class="border p-2">M</div>
                <div class="border p-2">L</div>
                <div class="border p-2">XL</div>
            </div>
          </div>
        ...
        <div class="flex flex-row ml-9 py-5 px-24">
            <div class="lg:w-1/3 sm:w-1/2 p-4">
                <div class="flex relative">
                <img class="rounded-l-2xl" alt="gallery"src="https://dummyimage.com/606x366">
                </div>
            </div>
